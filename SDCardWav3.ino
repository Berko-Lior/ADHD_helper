...
//  I2S configuration
      ...
      static const i2s_config_t i2s_config = 
      {
          ...
          .sample_rate = 16000,                                 // Note, this will be changed later
...
//------------------------------------------------------------------------------------------------------------------------
//https://firebasestorage.googleapis.com/v0/b/adhd-helper-bdfeb.appspot.com/o/device1?alt=media&token=f88e884c-e7a5-4c44-8b57-2e0f90e732ca
...
void setup() {    
    ...
    // get the wav file from the SD card 16bitfloat10secrecord.wav
    WavFile = SD.open("/16bitfloat10secrecord.wav");                   // Open the wav file
    if(WavFile==false)
