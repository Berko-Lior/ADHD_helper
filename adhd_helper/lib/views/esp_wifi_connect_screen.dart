...
import 'package:hashpro/utils/esp_wifi_config.dart';

// class EspWifiConnector extends StatelessWidget {
//   const EspWifiConnector({super.key});

//   @override
//   Widget build(BuildContext context) {
//     return IconButton(
//       onPressed: () => connectEspToWifi(bssid: '', ssid: '', password: '' ),
...
class EspWifiConnector extends ConsumerWidget {
  const EspWifiConnector({
    super.key,
  });

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final ssidController = TextEditingController(text: 'ICST');
    final bssidNameController =
        TextEditingController(text: '48:4a:e9:1b:91:66');
    final passwordController = TextEditingController(text: 'arduino123');
      ...
      child: ListView(
        children: [
          ...
          TextField(
            ...
            controller: bssidNameController,
          ),
          const SizedBox(height: 20),
          TextField(
          ...
          TextButton(
            onPressed: () => connectEspToWifi(
              ssid: ssidController.text,
              bssid: bssidNameController.text,
...
// class EspWifiConnector extends StatefulWidget {
//   @override
//   _EspWifiConnectorState createState() => _EspWifiConnectorState();
// }

// class _EspWifiConnectorState extends State<EspWifiConnector> {
//   final GlobalKey<FormState> formKey = GlobalKey<FormState>();
//   final TextEditingController ssid = TextEditingController(text: 'ICST');
//   final TextEditingController bssid =
//       TextEditingController(text: '48:4a:e9:1b:91:66');
//   final TextEditingController password =
//       TextEditingController(text: 'arduino123');
